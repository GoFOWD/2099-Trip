...
export default function HotelBooking() {
	...
	const [budget, setBudget] = useState(
		urlBudget ? Number(urlBudget) : 730000
	);
	...
	return (
		<div
			...
			<h4 style={{ marginTop: 16 }}>
				예약 가능 숙소 {budgetHotels.length}개
			</h4>
			...
			{showDetailPanel && selectedHotel && (
				<div
					...
					<h3 style={{ marginTop: 20, color: 'white' }}>
						객실 & 가격
					</h3>
								...
								{[
									...
									<button
										...
										style={{
											...
											borderRadius: 20,
											border: '1px solid #ccc',
											background: amenities.includes(a)
												? '#1f6feb'
												: '#fff',
											color: amenities.includes(a)
												? '#fff'
												: '#000'
										}}>
										{a}
