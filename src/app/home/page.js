    ...
    <div className="pb-[65px]">
      <div className="flex flex-col bg-white">
        ...
        <div className="flex gap-2 justify-around pb-4">
          <QuickIcon
            href="/planning/schedule/nonschedule/airline"
            src="/homeIcon/air.svg"
            alt="항공권 예약"
          >
            항공권
          </QuickIcon>
          <QuickIcon href="/" src="/homeIcon/hotel.svg" alt="숙소 예약">
            숙소
          </QuickIcon>
          <QuickIcon href="/exch" src="/homeIcon/exch.svg" alt="환율 정보">
            환율
          </QuickIcon>
          <QuickIcon href="/sos" src="/homeIcon/sos.svg" alt="긴급 정보">
            SOS
          </QuickIcon>
        </div>
      </div>
      <div className="px-4 mt-4">
        <h1 className="font-bold text-xl mb-4">어디로 떠나고 싶으신가요? ✈️</h1>
        <div className="mb-4">
          <MakeSchedule />
        </div>
        <div className="mb-4">
          ...
          {schedules.map((schedule) => (
            <Link key={schedule.id} href={`/planning/schedule/${schedule.id}`}>
              <Schedule
        ...
        <div className="mb-4">
          <h2 className="font-semibold text-lg">이달의 추천 여행지</h2>
        </div>
      </div>
    </div>
  );
